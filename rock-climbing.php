...
<img src="images/rockclimbing.jpg" style="height: 800px; width: 100%;">

    <div class="energy-level">
        <h2>rock-climbing Activities</h2>
        <p>Enter your desired distance from current location:</p>
        <div class="search-container">
            <button onclick="searchNearbyActivities('rock-climbing')">Search Nearby rock-climbing Activities</button>
...
$sql = "SELECT * FROM `free_activities` WHERE `activity` = 'rock-climbing'";
