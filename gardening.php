...
<title>Gardening Activities</title>
</head>
<body>
...
<img src="images/garden-5315602_1920.jpg" alt="meditation page banner" style="height: 800px; width: 100%;">
...
<script>
  ...
  function callback(results, status) {
    if (status == google.maps.places.PlacesServiceStatus.OK) {
      ...
      alert("No gardening spots found nearby. Please try again later or adjust your search settings.");
    }
  }
  ...
  function toggleFree() {
    freeOnly = !freeOnly;
    searchNearbyActivities('gardening');
  }
</script>
