...
<title>Photography Activities</title>
</head>
<body>
  <header class="header">
    <div class="nav">
...
<img src="images/photographer-407068_1920.jpg" alt="meditation page banner" style="height: 800px; width: 100%;">

<div class="energy-level">
  <h2>Photography Activities</h2>
  <p>Enter your desired distance from current location:</p>
  <div class="search-container">
    <button onclick="searchNearbyActivities('photography')">Search Nearby Photography Spots</button>
...
$sql = "SELECT * FROM `free_activities` WHERE `activity` = 'photography'";
...
<script>
  ...
  function callback(results, status) {
    if (status == google.maps.places.PlacesServiceStatus.OK) {
      ...
      alert("No activities found. Please try again later or adjust your search criteria.");
    }
  }
  ...
  function toggleFree() {
    freeOnly = !freeOnly;
    searchNearbyActivities('photography');
  }
</script>
