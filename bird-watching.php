...
<title>Birdwatching Activities</title>
</head>
<body>
  <header class="header">
    <div class="nav">
...
<img src="images/seagulls-815304_1920.jpg" alt="meditation page banner" style="height: 800px; width: 100%;">


<div class="energy-level">
  <h2>Birdwatching Activities</h2>
  <p>Enter your desired distance from current location:</p>

  <div class="search-container">
    <button onclick="searchNearbyActivities('birdwatching')">Search Nearby Birdwatching Spots</button>
...
$sql = "SELECT * FROM `free_activities` WHERE `activity` = 'bird-watching'";
...
<script>
  ...
  function callback(results, status) {
    if (status == google.maps.places.PlacesServiceStatus.OK) {
      ...
      alert("No birdwatching spots found nearby. Please try again later or adjust your search settings.");
    }
  }
  ...
  function toggleFree() {
    freeOnly = !freeOnly;
    searchNearbyActivities('birdwatching');
  }
</script>
