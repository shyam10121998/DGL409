...
<title>Walking Activities</title>
</head>
<body>
...
<div class="energy-level">
  ...
  <div class="search-container">
    <button onclick="searchNearbyActivities('walking')">Search Nearby Walking Trails</button>
...
<script>
  ...
  function callback(results, status) {
    if (status == google.maps.places.PlacesServiceStatus.OK) {
      ...
      alert("No walking trails found nearby. Please try again later or adjust your search settings.");
    }
  }
