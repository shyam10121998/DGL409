...
<img src="images/avenue-2215317_1920.jpg" alt="meditation page banner" style="height: 800px; width: 100%;">

<div class="energy-level">
  <h2>Parks Activities</h2>
  <p>Enter your desired distance from current location:</p>
  <div class="search-container">
    <button onclick="searchNearbyActivities('park')">Search Nearby Parks</button>
...
$sql = "SELECT * FROM `free_activities` WHERE `activity` = 'parks'";
...
<script>
  ...
  function callback(results, status) {
    if (status == google.maps.places.PlacesServiceStatus.OK) {
      ...
      alert("No parks found nearby. Please try again later or adjust your search settings.");
    }
  }
